...
app_logo = Label(frameCima, image=app_img, text=" Minhas Despesas", width=900, compound=LEFT, padx=5, relief=RAISED, anchor=NW, font=('Geometria 16 bold'), bg=co1, fg=co4)
